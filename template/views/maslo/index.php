...
<div class="tab" role="tabpanel">
    <ul class="nav nav-tabs mx-auto" role="tablist">
        ...
        <li class="nav-item mx-auto" role="presentation">
            <a class="nav-link" href="#p2" role="tab" data-toggle="tab">Топ популярности</a>
        </li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane active" id="p1">
            ...
            <?php if($year == date('Y')): ?>
                <div class="py-2">
                    <a class="badge badge-light" href="<?= $app->urlFor('maslo_archive', array('year' => 2016)) ?>" target="_blank">Рейтинг-2016</a>
                    <a class="badge badge-light" href="<?= $app->urlFor('maslo_archive', array('year' => 2017)) ?>" target="_blank">Рейтинг-2017</a>
                </div>
            <?php endif; ?>
            <div class="table-responsive">
                <table class="table table-hover rate-list">
                    ...
                    <tr>
                        ...
                        <th class="text-center break-all">Очков за подаренные подарки</th>
...
<script>
    $(function(){
        $(document.body).on('click', '.search-block button', function(e) {
            ...
            $.ajax({
                'url' 		: '<?= $app->urlFor('maslo_archive', array('action' => 'search', 'year' => $year)) ?>',
                'data' 		: {
