 ...
 *
 */
class MasloController extends GetGiveRateController
{
    protected $action_type = 'maslo2018';
    protected $image = 'https://i.oldbk.com/i/i/masl2016_%d_%s.png';

    public function __construct(Slim $container, $action, $year = 2016)
    {
        $this->year = (int)$year;

        $this->action_type = 'maslo'.$this->year;
        if($year == 2016) {
            $this->action_type = 'maslo';
        }
